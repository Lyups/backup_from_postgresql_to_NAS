...
2. **NAS-настройки**:
   - `NAS_SHARES`: Массив сетевых шар NAS в формате `//host/share`
   - `MOUNT_POINTS`: Массив точек монтирования для NAS_SHARES
...
- `sql` - Создание .sql дампов
- `backup` - Создание дампов в формате .backup
